...
else
{
	...
	echo "<TD CLASS=Alt1><DIV CLASS=normal>&nbsp;&nbsp;<b>Subject:</b></TD><TD CLASS=Alt1>&nbsp;&nbsp;<INPUT name=subject type=text size=55></TD></TR><TR>";
	...
	echo "<TD COLSPAN=2 ALIGN=RIGHT CLASS=Alt1><INPUT name=submit type=submit value='Add Topic'>&nbsp;&nbsp;";
	echo "</FORM></DIV></TD></TR>";
	echo "</TABLE>";
}
